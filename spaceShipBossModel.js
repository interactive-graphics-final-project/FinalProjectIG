...
textureLoader.load('./models/texture/t3.jpg', function (texture) {
...
SpaceShipBossModel.prototype.createBody = function () {
    ...
    var engineBox = new THREE.Mesh(engineGeometry, SpaceShipBossModel.materials);
    engineBox.position.y = 77.1;
    body.add(engineBox);

    // tetrahedron under body
    var cargoGeometry = new THREE.CylinderGeometry(0.84, 0.2, 4.3, 15);
    var cargoBox = new THREE.Mesh(cargoGeometry, SpaceShipBossModel.materials);
    ...
    var weightCargoBox = new THREE.Mesh(weightCargoGeometry, SpaceShipBossModel.materials);
...
SpaceShipBossModel.prototype.createBaseCannon = function () {
    ...
    var bodyBox1 = new THREE.Mesh(baseCannonGeometry, SpaceShipBossModel.materials);
    ...
    var bodyBox2 = new THREE.Mesh(CannonGeometry, SpaceShipBossModel.materials);
